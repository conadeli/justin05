...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "평일 오후 3시부터 9시까지, 토요일 오전 10시부터 오후 6시까지 가능합니다. 아이의 스케줄에 맞춰 고정 시간으로 진행하거나 매주 조율 가능합니다."
    },
    {
      question: "수업료는 얼마인가요?",
      answer: "월 4회 기준 16만원입니다. 첫 수업은 무료로 진행되며, 후기 작성 시 1회 수업을 추가로 증정해드려요. 자세한 할인 혜택은 상담 시 안내드립니다."
    },
    {
      question: "수업을 빠지면 어떻게 되나요?",
      answer: "24시간 전 미리 알려주시면 다른 날로 변경 가능합니다. 갑작스러운 사정으로 빠지더라도 월 1회까지는 보강 수업을 제공해드려요."
    }
  ];
